      ...
      if (stats.isEmpty) {
        return Center(
          child: Column(
            ...
            children: [
              Icon(Icons.bar_chart_rounded, size: m.iconSize48, color: theme.hintColor.withAlpha(100)),
              SizedBox(height: m.kSpace12),
              Text('暂无统计数据', style: theme.textTheme.bodyMedium?.copyWith(color: theme.hintColor)),
            ],
          ),
        );
      }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: color.withAlpha(80), blurRadius: 4, offset: const Offset(0, 1)),
                      ],
                    ),
                  ),
                  SizedBox(width: m.kSpace8),
