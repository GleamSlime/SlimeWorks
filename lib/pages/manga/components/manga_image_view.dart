...
class MangaProgressRing extends StatefulWidget {
  ...
  @override
  State<MangaProgressRing> createState() => _MangaProgressRingState();
}

class _MangaProgressRingState extends State<MangaProgressRing> {
  double _progress = 0;
  Timer? _timer;
...
class MangaImageView extends StatefulWidget {
  const MangaImageView({
    super.key,
    required this.image,
  ...
  @override
  State<MangaImageView> createState() => _MangaImageViewState();
}

class _MangaImageViewState extends State<MangaImageView> {
  ...
  @override
  void didUpdateWidget(covariant MangaImageView oldWidget) {
