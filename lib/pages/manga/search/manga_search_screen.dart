...
class _MangaSearchScreenState extends BasePageState<MangaSearchViewModel, MangaSearchScreen> {
  ...
  @override
  MangaSearchViewModel createViewModel() => MangaSearchViewModel();
...
/// Manga 标准分类列表（来自原项目 CateGoryMgr）
const List<String> _kMangaCategories = [
  '嗶咔漢化',
  '全彩',
  '長篇',
  '同人',
