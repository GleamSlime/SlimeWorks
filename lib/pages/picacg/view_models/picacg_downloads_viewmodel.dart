...
class PicAcgDownloadsViewModel extends BaseViewModel {
  final PicAcgDownloadService _dl = getIt<PicAcgDownloadService>();

  /// 所有下载条目（实时响应，直接绑定 service RxMap）
  RxMap<String, PicAcgDownloadEntry> get entries => _dl.entries;
