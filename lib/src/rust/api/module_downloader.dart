...
abstract class ModuleDownloader implements RustOpaqueInterface {
  ...
  /// 创建模块下载器
  static Future<ModuleDownloader> newInstance({required PathBuf installDir}) async {
    throw UnimplementedError('ModuleDownloader.newInstance is not available. Regenerate FRB bindings after exposing the constructor in Rust.');
  }
